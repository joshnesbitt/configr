...
Configurable is intended to be framework agnostic, but it's easy to get it going within Rails/Sinatra/Hot New Framework app.

=== Rails

You can use Configurable within Rails quite easily. I don't really plan to provide any "out of the box" way to hook Configurable into Rails but it's quite easy to implement:
