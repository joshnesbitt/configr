module Configurable
  describe Hash do
    ...
    it "should normalize a set of Hash values to a Configurable Hash if they are themselves Hashes" do
      hash = Hash.new({ "one" => "one", "two" => "two", "three" => { "four" => "four" } })
      ...
      hash[:three].class.should == Configurable::Hash
    end
    
    it "should recursively normalize a set of Hash values to a Configurable Hash if they are themselves Hashes" do
      ...
      hash[:three].class.should        == Configurable::Hash
      hash[:three][:five].class.should == Configurable::Hash
    end
